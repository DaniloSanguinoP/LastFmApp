package com.example.lastfmapp.constants;
...
public class AppConstant {
    ...
    public static final String LOCATION = "Colombia";
    public static final int LIMIT_ARTISTS = 10;
    public static final int LIMIT_TRACKS = 5;
